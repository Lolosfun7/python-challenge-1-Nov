...
# Empty order list to store customer's selections
order_list = []
...
while place_order:
    ...
    print_menu()
    menu_selection = input("Enter the nunber of the item you'd like t order: ")
    ...
    quantity_input = input(f"How man {item_name}s would you like? (Default is 1): ")
    
    if not quantity_input.isdigit():
        print("Invalid quantity. Defaulting to 1.")
        quntity = 1
    else:
        quanity = int(quantity_input)
    ...
    while True:
        ...
        continue_order = input("Would you like to order more? (y/n): ").lower()
...
print(f"n\Total: ${total_price:2f}")
